    ...
    return (
        <div className="bg-emerald-100/80 min-h-screen pb-32">
                ...
                <div className="w-full">
                    ...
                    <div className="w-full flex justify-between items-center">
                        <div className="flex items-center space-x-3 mb-5">
                            <span className="px-6 py-3 border border-black/10 bg-amber-600 text-xs text-start font-black uppercase tracking-widest text-white hover:bg-blue-600 transition shadow-lg">
                                {post.category?.name}
                            </span>
                            <div className="w-2 h-2 bg-black rounded-full mr-2"></div>
                            <span className="block text-xs text-start font-black text-black uppercase tracking-widest">5 min read</span>
                        </div>
                        <Link to="/blog" className="px-6 py-3 flex gap-1 items-center border border-black/10 bg-emerald-600 text-xs text-start font-black uppercase tracking-widest text-white hover:bg-blue-600 transition shadow-lg">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 py-5 border-t border-black">
                        <div className="flex items-center space-x-4">
                            <div>
                                ...
                                <p className="px-6 py-3 border border-black/10 bg-amber-600 text-xs text-start font-black uppercase tracking-widest text-white hover:bg-blue-600 transition shadow-lg">{post.author?.name}</p>
                            </div>
                        </div>
            ...
            <div className="w-full mb-10">
                <div className="aspect-[21/9] overflow-hidden shadow-2xl">
            ...
            {/* Content */}
            <div className="w-full ">
                <div className="prose prose-2xl prose-gray max-w-none grid grid-cols-2">
                    ...
                    <div className="text-xl text-justify text-gray-600 leading-[1.8] whitespace-pre-line space-y-6">
                        {post.content}
                    </div>
                </div>

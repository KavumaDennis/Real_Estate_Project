                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-green-600 border-b border-gray-100">
                                <th className="px-8 py-4 text-[10px] font-black text-white uppercase tracking-[0.2em]">Page Title</th>
                                <th className="px-8 py-4 text-[10px] font-black text-white uppercase tracking-[0.2em]">Route Slug</th>
                                <th className="px-8 py-4 text-[10px] font-black text-white uppercase tracking-[0.2em]">Last Updated</th>
                                ...
                                <tr key={p.id} className="bg-green-100 transition-colors group">
                                    <td className="px-8 py-6">
                                        <div className="flex items-center space-x-4">
                                            <div className="h-12 w-12 bg-gray-50 border border-black/30 text-indigo-600 flex items-center justify-center group-hover:scale-105 transition">

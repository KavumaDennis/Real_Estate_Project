    ...
    return (
        <div className="space-y-8 pb-20">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Link to="/properties" className="px-6 py-3 flex items-center gap-2 border border-black/10 bg-teal-700 text-xs font-black uppercase tracking-widest text-white hover:bg-blue-600 transition shadow-lg w-fit">
                    Browse More
                </Link>
            </div>

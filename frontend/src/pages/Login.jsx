...
const Login = () => {
    ...
    return (
        <div className="min-h-[80vh] bg-emerald-100/80 grid grid-cols-2 gap-5 py-10">
            <div className="h-full w-full flex flex-col gap-3 items-start justify-center">
                <div className="">
                ...
                <div className="w-full h-50">
                    <img src="/public/Residential.jpg" className='w-full h-full object-cover' alt="" />
                </div>
                <p className='block text-base text-start font-black text-black uppercase tracking-widest'>
                    Your partners in property;
                    when you move, so do we.
                </p>
            </div>
            <div className="w-full relative lg:col-span-1 col-span-2 space-y-8 border bg-green-600 p-10 py-15 shadow-xl">
                ...
                <div className="text-start z-10 w-full">
                    <h2 className="text-lg text-black text-start font-black uppercase tracking-widest ">Welcome back</h2>
                ...
                <form className="mt-8 space-y-6 z-10 relative" onSubmit={handleSubmit}>

            ...
            <div className="">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    {user?.role?.slug === 'admin' || user?.role?.slug === 'super-admin' && (
                        <a href="/admin/users" className="px-6 py-3 w-fit border border-black/10 bg-indigo-600 text-xs text-start font-black uppercase tracking-widest text-white hover:bg-blue-600 transition shadow-lg">
                            Admin Dashboard
                        </a>
                    )}
                </div>

        ...
        <div className="min-h-screen py-2">
            <div className="w-full">
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="mt-6 md:mt-0 relative flex items-center bg-indigo-600 border border-black/30">
                            ...
                            <>
                                <div className="my-3 flex justify-between items-center">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <select className="border border-black/20 bg-green-600/80 font-black text-gray-900 focus:outline-none cursor-pointer p-0.5">
                                ...
                                {properties.length > 0 && (
                                    <div className="mt-20 flex justify-center">
                                        <button className="px-12 py-3 bg-teal-600 border border-gray-100 shadow-sm text-white font-black hover:bg-gray-50 transition">

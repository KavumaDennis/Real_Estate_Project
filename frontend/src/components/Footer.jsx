            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="grid grid-cols-2 gap-8 col-span-1 lg:col-span-2">
                        <div>
                            <h4 className="text-sm font-black text-start text-indigo-600 uppercase tracking-widest mb-8">Discovery</h4>
                            <ul className="space-y-4">
                                {['Properties', 'Featured Listings', 'New Projects', 'Luxury Homes'].map(item => (
                                    <li key={item}>
                                        <Link to="/properties" className="text-gray-400 hover:text-indigo-600 transition font-medium flex items-center group">
                        ...
                        <div>
                            <h4 className="text-sm font-black text-start text-indigo-600 uppercase tracking-widest mb-8">Company</h4>
                            <ul className="space-y-4">
                                {['About Us', 'Agents', 'Blog', 'Contact'].map(item => (
                                    <li key={item}>
                                        <Link to={`/${item.toLowerCase().replace(' ', '-')}`} className="text-gray-400 hover:text-indigo-600 transition font-medium flex items-center group">
                                            <span className="h-1.5 w-0 bg-teal-700 group-hover:w-3 mr-0 group-hover:mr-2 transition-all"></span>
                                            {item}
                                        </Link>
                                    </li>
                    ...
                    <div>
                        <h4 className="text-sm font-black text-start text-indigo-600 uppercase tracking-widest mb-8">Connect</h4>
                        <ul className="space-y-6">
                            <li className="flex items-center space-x-4">
                                <div className="h-10 w-10 bg-gray-800 rounded-xl flex items-center justify-center text-indigo-600 flex-shrink-0">
                                    <HiOutlineLocationMarker size={20} />
                                </div>
                                <span className="text-gray-400 text-start font-medium leading-relaxed">
                                    123 Luxury Avenue, Suite 500 New York, NY 10001
                                </span>
                            </li>
                            <li className="flex items-center space-x-4">

...
const AdminLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-emerald-100/80 backdrop-blur-2xl overflow-hidden relative">
            ...
            `}>
                <div className="px-6 py-3 bg-teal-700 flex items-center justify-between border border-black/20 ">
                ...
                <nav className="flex-grow bg-teal-700 pl-0 border border-black/20 p-4 space-y-2 overflow-y-auto scrollbar-hide">
                    {menuItems.map((item) => (
                        <Link
                            key={item.name}
                            to={item.path}
                ...
                <div className="p-4 pl-0 bg-teal-700 border border-black/20 space-y-2">
                    <button
                        onClick={logout}
            ...
            <div className="flex-grow flex flex-col overflow-hidden w-full">
                <header className="h-13.5 border ml-1 border-black/20 bg-teal-700 flex items-center justify-between px-4 lg:px-8 shrink-0">
